...
export const labels = {
  en: {
    ...
    "features.Fragment": "These are some benefits of working with",
    "features.FragmentHighlight": "Hontech",

    // Custom Software Features
    "features.FlexibleIntegration": "Flexible Integration",
    "features.FlexibleIntegration-2":
      "Hontech develops custom software tailored to your business needs. Whether you're using React, Vue, or plain JavaScript, we ensure smooth integration with your existing systems and third-party services.",

    "features.SeamlessIntegrations": "Seamless Integrations",
    "features.SeamlessIntegrations-2":
      "Our custom software solutions connect effortlessly with your favorite tools, APIs, and databases, making automation and data synchronization simpler than ever.",

    "features.DedicatedSupportCollaboration":
      "Dedicated Support & Collaboration",
    "features.DedicatedSupportCollaboration-2":
  ...
  es: {
    ...
    // Compatibility
    "compatibility.ContentSection":
      "¿Por qué Hontech para el desarrollo de software personalizado y diseño de página web?",
    ...
    "features.Fragment": "Estos son algunos beneficios de trabajar con",
    "features.FragmentHighlight": "Hontech",

    // Características de Software Personalizado
    "features.FlexibleIntegration": "Integración Flexible",
    "features.FlexibleIntegration-2":
      "Hontech desarrolla software personalizado adaptado a las necesidades de tu negocio. Ya sea que uses React, Vue o JavaScript puro, garantizamos una integración fluida con tus sistemas existentes y servicios de terceros.",

    "features.SeamlessIntegrations": "Integraciones Sin Esfuerzo",
    "features.SeamlessIntegrations-2":
      "Nuestras soluciones de software personalizado se conectan fácilmente con tus herramientas, APIs y bases de datos favoritas, simplificando la automatización y sincronización de datos.",

    "features.DedicatedSupportCollaboration": "Soporte Dedicado y Colaboración",
    "features.DedicatedSupportCollaboration-2":
    ...
    "showcase.ViewAllLandingPageProjects":
      "ver todos los proyectos de páginas web",
