...
export const labels = {
  ...
  es: {
    ...
    "splash.dream": "Construimos",
    "splash.website": "Tu sitio web o",
    "splash.custom": "Landing page para",
    "splash.software": "Tu negocio",

    // Compatibility
    "compatibility.ContentSection":
      "¿Por qué Hontech para el diseño de página web o Landin page?",
    "compatibility.at-hontech": "En Hontech",
    "compatibility.specialize": "nos especializamos en",
    "compatibility.solutions": "el diseño de paginas web y",
    "compatibility.solutions-2": "landing pages",
